...
/*   Updated: 2026/01/23 17:31:49 by soochoi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	print_msg("Deep copy Test(Dog class)");
	{
		...
		dog->setBrain("Yummy2");
		dog->setBrain("Yummy3");
		for (int i = 0; !(dog->getBrain(i).empty()); i++)
		{
			std::cout << "dog->getBrain(" << i << "): "\
				<< dog->getBrain(i) << std::endl;
		}

		print_msg("Incorrect Index Test");
		std::cout << "dog->getBrain(" << 6 << "): "\
			<< dog->getBrain(6) << std::endl;
		...
		for (int i = 0; !(copy_->getBrain(i).empty()); i++)
		{
			std::cout << "copy_->getBrain(" << i << "): "\
				<< copy_->getBrain(i) << std::endl;
		}
...

	{
		...
		cat->setBrain("Yummy2");
		cat->setBrain("Yummy3");
		for (int i = 0; !(cat->getBrain(i).empty()); i++)
		{
			std::cout << "cat->getBrain(" << i << "): "\
				<< cat->getBrain(i) << std::endl;
		}

		print_msg("Incorrect Index Test");
		std::cout << "cat->getBrain(" << 6 << "): "\
			<< cat->getBrain(6) << std::endl;
